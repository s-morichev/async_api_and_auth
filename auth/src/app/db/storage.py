...
class AbstractStorage(ABC):
    @abstractmethod
    def set_token(self, user_id: str, device_id: str, token_id: str, expires_at: int):
        """устанавливаем токен как валидный"""

    @abstractmethod
    def check_token(self, user_id: str, device_id: str, token_id: str):
        """проверяем токен на валидность"""

    @abstractmethod
    def exist_token(self, user_id: str, device_id: str) -> bool:
        """key exists"""

    @abstractmethod
    def remove_token(self, user_id: str, device_id: str):
    ...
    @abstractmethod
    def get_devices(self, user_id: str) -> list[str | None]:
        pass

    @abstractmethod
    def add_device(self, user_id: str, device_id: str):
        pass
    ...
    @abstractmethod
    def get_info(self, user_id: str, device_id: str) -> dict:
...
class Storage(AbstractStorage):
    ...
    @staticmethod
    def token_key(user_id: str, device_id: str) -> str:
    ...
    @staticmethod
    def info_key(user_id: str, device_id: str) -> str:
