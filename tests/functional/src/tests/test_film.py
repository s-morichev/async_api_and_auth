...
testdata = [
    ...
    ({"sort": "-imdb_rating"}, {"status": 200, "total": 20, "0#title": "First film", "19#title": "Film Last"}, "increasing sort order"),
    ({"sort": "+imdb_rating"}, {"status": 200, "total": 20, "0#title": "Film Last", "19#title": "First film"}, "decreasing sort order"),
    ({"sort": "invalid sort key"}, {"status": 422}, "invalid sort parameter"),
    ({"filter[genre]": "715b726d-2239-4984-99d6-89420a6634c0"}, {"status": 200, "total": 13, "0#title": "First film", "12#title": "Movie 13"}, "filter by genre"),
...
testdata = [
    ...
    ({"query": "movie", "filter[genre]": "715b726d-2239-4984-99d6-89420a6634c0"}, {"status": 200, "total": 12}, "filter by genre"),
    ({"query": "movie", "filter[genre]": "a48f8db2-7ae2-4bea-8f55-be6590c5b8d4"}, {"status": 404}, "filter by non existent genre"),
